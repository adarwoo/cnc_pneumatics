 ...
 * Allow the macro to be defined outside (through -D option) and set the value only if not
 * already defined.
 */
#ifndef _LOG_MAX_TRACE
...
#define _LOG_MAX_THREAD_ID_REPR_LENGTH   15
...
#ifdef LOG_MAX_MQUEUE_DEPTH
#define _LOG_MAX_MQUEUE_DEPTH           LOG_MAX_MQUEUE_DEPTH
#else
#define _LOG_MAX_MQUEUE_DEPTH           300
#endif
