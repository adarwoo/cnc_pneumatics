...
#define VPORTA              (*(VPORT_t *) SIM_OFFSET(0x0000)) /* Virtual Ports */
#define VPORTB              (*(VPORT_t *) SIM_OFFSET(0x0004)) /* Virtual Ports */
#define VPORTC              (*(VPORT_t *) SIM_OFFSET(0x0008)) /* Virtual Ports */
#define RSTCTRL           (*(RSTCTRL_t *) SIM_OFFSET(0x0040)) /* Reset controller */
#define SLPCTRL           (*(SLPCTRL_t *) SIM_OFFSET(0x0050)) /* Sleep Controller */
#define CLKCTRL           (*(CLKCTRL_t *) SIM_OFFSET(0x0060)) /* Clock controller */
#define BOD                   (*(BOD_t *) SIM_OFFSET(0x0080)) /* Bod interface */
#define VREF                 (*(VREF_t *) SIM_OFFSET(0x00A0)) /* Voltage reference */
#define WDT                   (*(WDT_t *) SIM_OFFSET(0x0100)) /* Watch-Dog Timer */
#define CPUINT             (*(CPUINT_t *) SIM_OFFSET(0x0110)) /* Interrupt Controller */
#define CRCSCAN           (*(CRCSCAN_t *) SIM_OFFSET(0x0120)) /* CRCSCAN */
#define RTC                   (*(RTC_t *) SIM_OFFSET(0x0140)) /* Real-Time Counter */
#define EVSYS               (*(EVSYS_t *) SIM_OFFSET(0x0180)) /* Event System */
#define CCL                   (*(CCL_t *) SIM_OFFSET(0x01C0)) /* Configurable Custom Logic */
#define PORTA                (*(PORT_t *) SIM_OFFSET(0x0400)) /* I/O Ports */
#define PORTB                (*(PORT_t *) SIM_OFFSET(0x0420)) /* I/O Ports */
#define PORTC                (*(PORT_t *) SIM_OFFSET(0x0440)) /* I/O Ports */
#define PORTMUX           (*(PORTMUX_t *) SIM_OFFSET(0x05E0)) /* Port Multiplexer */
#define ADC0                  (*(ADC_t *) SIM_OFFSET(0x0600)) /* Analog to Digital Converter */
#define AC0                    (*(AC_t *) SIM_OFFSET(0x0680)) /* Analog Comparator */
#define USART0              (*(USART_t *) SIM_OFFSET(0x0800)) /* Universal Synchronous and Asynchronous Receiver and Transmitter */
#define USART1              (*(USART_t *) SIM_OFFSET(0x0820)) /* Universal Synchronous and Asynchronous Receiver and Transmitter */
#define TWI0                  (*(TWI_t *) SIM_OFFSET(0x08A0)) /* Two-Wire Interface */
#define SPI0                  (*(SPI_t *) SIM_OFFSET(0x08C0)) /* Serial Peripheral Interface */
#define TCA0                  (*(TCA_t *) SIM_OFFSET(0x0A00)) /* 16-bit Timer/Counter Type A */
#define TCB0                  (*(TCB_t *) SIM_OFFSET(0x0A80)) /* 16-bit Timer Type B */
#define TCB1                  (*(TCB_t *) SIM_OFFSET(0x0A90)) /* 16-bit Timer Type B */
#define SYSCFG             (*(SYSCFG_t *) SIM_OFFSET(0x0F00)) /* System Configuration Registers */
#define NVMCTRL           (*(NVMCTRL_t *) SIM_OFFSET(0x1000)) /* Non-volatile Memory Controller */
#define SIGROW             (*(SIGROW_t *) SIM_OFFSET(0x1100)) /* Signature row */
#define FUSE                 (*(FUSE_t *) SIM_OFFSET(0x1280)) /* Fuses */
#define LOCK_BIT          (*(LOCKBIT_t *) SIM_OFFSET(0x128A)) /* Lockbit */
#define USERROW           (*(USERROW_t *) SIM_OFFSET(0x1300)) /* User Row */
